...
// actions, not a dropzone. Local-preview only here: the file is only
// actually uploaded to Supabase Storage once bootstrap_clinic() returns a
// clinic_id (see onboarding-wizard.tsx and api.ts) — a logo can't be
// stored under a clinic that doesn't exist yet. Selection and removal are
// lifted to onboarding-wizard.tsx (same pattern as account/clinic/role) so
// the logo survives Paso 2 → Paso 3 → Atrás. The column heading ("Logo de
// tu clínica") lives in clinic-step.tsx, not here.
