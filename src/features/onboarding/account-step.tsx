...
// Paso 1 — creates a real Supabase Auth account (see api.ts signUpAccount)
// on submit. The actual signUp call and its outcome (signed in / needs
// email confirmation / error) are handled by the parent
// (onboarding-wizard.tsx), which owns the session/step state this
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} noValidate className="mt-5 flex flex-col gap-3">
        ...
        >
          {submitting ? "Creando tu cuenta…" : "Continuar"}
        </button>
      </form>
