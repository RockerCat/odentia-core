...
// Combobox (Paciente, Profesional, Consultorio below) now lives in
// @/components/combobox — extracted so other pickers across Odentia (see
// ProfessionalSelect) reuse the exact same component instead of a second
