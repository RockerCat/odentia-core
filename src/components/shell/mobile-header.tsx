            ...
            <>
              ...
              >
                ...
                <button
                  ...
                  role="menuitem"
                  disabled={signingOut}
                  // See header.tsx's own comment: deliberately no
                  // setMenuOpen(false) here — closing the menu instantly
                  // used to hide any pending feedback before Supabase
                  // signOut + the router.push("/login") transition
                  // actually finished.
