...
// plus one synthetic `confirmed` row (FUTURE_CONFIRMED_APPOINTMENT_ID)
// added specifically for scripts/qa-can-start-encounter-check.mjs: none of
// the real-snapshot rows above are scheduled/confirmed (only in_progress
// or terminal), so there was nothing in this fixture to exercise
// canStartClinicalEncounter's 30-minute window against.
