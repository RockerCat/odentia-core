...
the bundled generic asset, resolved at render only, never stored); team = the whole ACTIVE
team (clinic_admin/dentist/assistant) from `get_my_clinic_team()` — shown by
